		...
		<div class="inner">
			...
			<div class="content">
			    ...
			    <div>
			        ...
			        <button type="button" class="btn" style="background-color: lightgray; width: 130px;" onclick="statusCon(2);">클래스 미노출</button>
			        <br><br>
			    ...
			    <div>
			        <p style="font-size:20px;"><b>클래스 리뷰 관리</b></p>
			        ...
			        <div>
						...
						<c:if test="${pi.listCount > 0 }">
							<div id="pagingAreaReview">
								<ul class="pagination">
									<c:if test="${ pi.currentPage > 1 }">
										<li class="page-item">
											<a class="page-link" 
											href="classManagerReview.ad?cpage=${pi.currentPage - 1}&clNo=${c.clNo}&array=${ cm.array }&category=${ cm.category }&keyword=${cm.keyword}&yclass=${cm.yclass}&nclass=${cm.nclass}&rarray=${rarray}&rcategory=${rcategory}&rkeyword=${rkeyword}&before=${cm.before}&after=${cm.after}&rpage=${cm.rpage}">
											Previous</a>
										</li>
									</c:if>
									<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
										<li class="page-item">
											<a class="page-link" href="classManagerReview.ad?cpage=${ p }&clNo=${c.clNo}&array=${ cm.array }&category=${ cm.category }&keyword=${cm.keyword}&yclass=${cm.yclass}&nclass=${cm.nclass}&rarray=${rarray}&rcategory=${rcategory}&rkeyword=${rkeyword}&before=${cm.before}&after=${cm.after}&rpage=${cm.rpage}">
											${ p }</a>
										</li>
									</c:forEach>
									<c:if test="${ pi.currentPage != pi.maxPage }">
										<li class="page-item">
											<a class="page-link" href="classManagerReview.ad?cpage=${ pi.currentPage + 1}&clNo=${c.clNo}&array=${ cm.array }&category=${ cm.category }&keyword=${cm.keyword}&yclass=${cm.yclass}&nclass=${cm.nclass}&rarray=${rarray}&rcategory=${rcategory}&rkeyword=${rkeyword}&before=${cm.before}&after=${cm.after}&rpage=${cm.rpage}">
											Next</a>
										</li>
									</c:if>
								</ul>
