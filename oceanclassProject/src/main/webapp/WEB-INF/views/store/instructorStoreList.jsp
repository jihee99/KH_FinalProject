...
<style>
    ...
    .contentBox>table{width: 80%; margin-left: auto; margin-right: auto; padding: 10px; background-color: lightgray; border-radius: 2px;}
    ...
    .info_area h3{font-size: 27px; font-weight: 900;}
    .info_area{font-size: 16px;}
    .btn_area_2 button{width: 48%; margin-left: 5px; font-size: 16px; font-weight: bolder; border: none; color: white;}
