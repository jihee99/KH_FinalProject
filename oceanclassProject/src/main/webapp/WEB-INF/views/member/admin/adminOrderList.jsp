            ...
            <form action="">
                <table>
                    <tr>
                        ...
                        <td width="300">
                            <input type="radio" class="orderType" name="orderType" id="class" value="class">
                            <label for="class">클래스</label>
                            &nbsp;&nbsp;&nbsp;
                            <input type="radio" class="orderType" name="orderType" id="store" value="store" checked="checked">
