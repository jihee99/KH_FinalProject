    ...
    <div style="height: auto; margin: auto; width: 1600px;">
        ...
        <div id="wrap">
            ...
            <div class="content my-5">
            	<form action="insertQna.ad" method="post" id="enrollForm">
	                ...
	                <table class="table table-bordered">
	                        ...
	                        <tr>
	                            <th>카테고리</th>
	                            <td name="category" colspan="3">${q.category }</td>
	                        </tr>
	                        <tr>
	                            <th >문의내용</th>
	                        ...
	                        <tr>
	                            <th >답변</th>
	                            <td colspan="3"><textarea name="ansContent" id="" cols="70" rows="5" style="resize: none;">${q.ansContent }</textarea></td>
	                        </tr>
	                </table>
	                <div id="btnBox">
	                    <button type="submit" id="Enroll" class="btn" style="background-color: rgb(107, 171, 213); color: white;">등록/수정</button>
	                    <button type="button" onclick="history.back()" id="cancel" class="btn" style="background-color:gray; color: white;" >목록</button>
	                </div>
                </form>
            </div>
          <br><br><br>
