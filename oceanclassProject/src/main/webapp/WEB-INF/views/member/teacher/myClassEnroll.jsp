            ...
            <div id="enroll-form">
                <form action="" method="post" id="enrollForm">
                    ...
                    <div class="box">
                        ...
                        <div class="input-area">
                            <input type="text" id="userId" name="userId" placeholder="클래스명을 입력 하세요." required>
                            <span>클래스명은 등록 후 수정이 불가능 합니다. 신중히 입력해 주세요.</span>
                        </div>
                    </div>

                    <div class="box">
                        <label class="textName" for="userPwd">클래스 설명<span class="star">*</span></label>
                        <div class="input-area">
                    ...
                    <div class="box">
                        <label class="textName" for="userPwdCk">타이틀 이미지<span class="star">*</span></label>
                        <div class="input-area">
                            <input type="file" id="userPwdCk" name="userPwdCk" required>
                        </div>
                    </div>

                    <div class="box">
                        <label class="textName" for="userPwdCk">소개 이미지<span class="star"></span></label>
                        <div class="input-area">
                            <input type="file" id="userPwdCk" name="userPwdCk">
                        </div>
                    </div>

                    <div class="box">
                        <label class="textName" for="userId">커리큘럼 이미지<span class="star"></span></label>
                        <div class="input-area">
                            <input type="file" id="userId" class="w200" name="userId">
                        </div>
                    </div>

                    <div class="box">
                        <label class="textName" for="userId">클래스 가격<span class="star">*</span></label>
                        <div class="input-area">
                    ...
                    <div class="box">
                        <label class="textName" for="userId">키트 유무<span class="star">*</span></label>
                        <div class="input-area">
                    ...
                    <div class="box">
                        <label class="textName" for="userId">키트소개 이미지<span class="star"></span></label>
                        <div class="input-area">
                            <input type="file" id="userId" class="w200" name="userId">
                        </div>
                    </div>
