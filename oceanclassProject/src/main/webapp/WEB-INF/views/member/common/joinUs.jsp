            ...
            <div id="join-form">
                <form action="insert.me" method="post" id="joinForm">
                    ...
                    <div class="box">
                        ...
                        <div>
	                        <div class="input-area">
	                        	...
	                        	<input type="hidden" name="checked_nick" value="" required>
	                        </div>
					...
					$("#nickCheck").click(function(){
                    	$("input[name='checked_nick']").val('yy');
                    })
                    ...
                    <div class="box">
                        ...
                        <div>
	                        <div class="input-area">
	                            ...
	                            <button type="button" class="rightBtn btn-sm btn-light" id="phoneChk">본인 인증</button>
	                        </div>
                    ...
                    <div class="box">
                        ...
                        <div>
	                        <div class="input-area">
	                            <input type="number" id="phone2" class="w200" name="num" placeholder="인증번호" disabled required>
	                            <button type="button" id="phoneChk2" class="rightBtn btn-sm btn-light">인증 확인</button>
